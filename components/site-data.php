<?php
  ...
  $menu_main = array("Avaleht" => "index.php", "Uudised" => "news.php", "Meeskond" => "team.php", "Harjutused" => "exercises.php", "Lisaülesanne" => "extra_ex.php");
  ...
  $extra_exercise_content = "<h2>Yay, I did it!</h2>";
  $footer_text = "Arvestustöö: Merili Asu - 30.09.2014";
